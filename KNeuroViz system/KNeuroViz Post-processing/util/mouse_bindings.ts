...
// import * as lgv from "../layer_group_viewer";
...
export class MouseEventBinder<EventMap extends EventActionMapInterface> extends RefCounted {
  ...
  constructor(public target: EventTarget, public eventMap: EventMap) {
    ...
    // this.idEle = document.getElementsByClassName("neuroglancer-layer-item-value")[0];

    // var idVal = document.getElementsByClassName("neuroglancer-layer-item-value")[0];

    //Joe
    // this.registerEventListener(target, 'mousemove', (event: MouseEvent) => {
    //   // console.log('event.toElement: '+event.toElement);
    //   // console.log("event.target: "+event.target);
    //   // console.log('event.layerX: '+event.layerX);
    //   // console.log("*** ID: "+document.getElementsByClassName("neuroglancer-layer-item-value")[0].innerHTML); //OK
